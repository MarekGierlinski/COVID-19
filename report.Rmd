...
```{r daily_bad, fig.width=10, fig.height=5, message=FALSE, warning=FALSE}
readd(fig_weekly_cases_2)
readd(fig_weekly_deaths_2)
```
...
```{r daily_secnd, fig.width=10, fig.height=5, message=FALSE, warning=FALSE}
readd(fig_weekly_cases_3)
readd(fig_weekly_deaths_3)
```
