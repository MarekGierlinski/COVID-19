...
Reported daily cases and deaths (per million), averaged over last seven days. Only countries with at least 1 million population are included. Error bars are 95% confidence intervals. The plot shows the top 20 countries.
...
```{r fig_testing, fig.width=7, fig.height=3, message=FALSE, warning=FALSE}
