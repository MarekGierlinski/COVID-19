...
plots <- drake_plan(
  ...
  fig_shifted_cases_pop = plot_shifted(covid_sel, what="cases_pop", val.min=0.1, val.max=10),
  fig_shifted_deaths_pop = plot_shifted(covid_sel, what="deaths_pop", val.min=0.02, val.max=1),
